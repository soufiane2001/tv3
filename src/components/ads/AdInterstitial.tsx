  ...
  return (
    <div className="relative min-h-[56vw] sm:min-h-0 sm:aspect-video rounded-xl sm:rounded-2xl overflow-hidden bg-gray-950 flex flex-col items-center justify-center border border-white/10">
      ...
      <div className="absolute bottom-3 right-3 flex items-center gap-2">
        <span className="text-gray-400 text-xs">Stream dans</span>
        <button
        ...
        >
          {seconds > 3 ? `${seconds}s` : 'Regarder ▶'}
        </button>
      </div>
      <p className="absolute top-3 left-3 text-[10px] text-gray-600 uppercase tracking-wider">Publicité</p>
    </div>
  );
}
