...
const SECTION_ICONS: Record<string, { fa: string; cls: string; color: string }> = {
  'Match Preview': { fa: 'fa-solid fa-file-lines',  cls: 'icon-box-blue',  color: 'text-blue-400'  },
  'Head-to-Head':  { fa: 'fa-solid fa-chart-bar',   cls: 'icon-box-amber', color: 'text-amber-400' },
  'Prediction':    { fa: 'fa-solid fa-bullseye',     cls: 'icon-box-red',   color: 'text-red-400'   },
};
...
const SectionTitle = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="flex items-center gap-3">
      {meta
        ? <div className={`icon-box ${meta.cls}`}><i className={`${meta.fa} ${meta.color} text-lg`} /></div>
      ...
      <Card>
        ...
        {broadcastInfo && (
          <div className="flex items-center gap-2.5 pt-3 border-t border-white/[0.06]">
            <div className="icon-box icon-box-red !w-7 !h-7 shrink-0"><i className="fa-solid fa-tv text-red-400 text-sm" /></div>
          ...
          <Card key={team.name}>
            ...
            <div className="flex items-center gap-3">
              {team.logo ? (
                ...
                <div className="icon-box icon-box-red !w-9 !h-9">
