...
const EXTRA = [
  { slug: 'rai-1',    name: 'Rai 1',   streamUrl: 'https://srv1.adriatelekom.com/Rai1/index.m3u8',                            sublabel: 'Italy · RAI · HD' },
  { slug: 'ortb1',    name: 'ORTB',    streamUrl: 'https://strhls.streamakaci.tv/ortb/ortb1-multi/playlist.m3u8',              sublabel: 'ORTB · HD' },
