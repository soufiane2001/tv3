...
export const metadata: Metadata = buildMatchMetadata('korea-vs-czechia-2026');
...
export default async function Page() {
  ...
  return (
    <>
      <JsonLd data={buildMatchJsonLd('korea-vs-czechia-2026')} />
      <JsonLd data={buildBreadcrumbJsonLd('korea-vs-czechia-2026')} />
      <WC2026MatchLayout
