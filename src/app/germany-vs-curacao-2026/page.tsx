...
export const metadata: Metadata = buildMatchMetadata('germany-vs-curacao-2026');
...
export default async function Page() {
  ...
  return (
    <>
      <JsonLd data={buildMatchJsonLd('germany-vs-curacao-2026')} />
      <JsonLd data={buildBreadcrumbJsonLd('germany-vs-curacao-2026')} />
      <WC2026MatchLayout
