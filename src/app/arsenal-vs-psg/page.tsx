...
const KEYWORDS = [
  ...
  'bein sport arsenal psg uhd','beinsports uhd arsenal psg live',
  'بين سبورت نهائي ارسنال باريس','bein sports uhd live stream free',
...
const matchJsonLd = {
  ...
  location: {
    ...
    url: 'https://www.allianz-arena.com',
  },
  offers: {
    '@type': 'Offer',
    name: 'Free Live Stream — Arsenal vs PSG UCL Final 2026',
    price: '0',
    priceCurrency: 'EUR',
