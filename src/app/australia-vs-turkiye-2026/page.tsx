  ...
  return (
    <>
      ...
      <WC2026MatchLayout
        ...
        meta={{ date: 'Saturday, 13 June 2026', time: '04:00 UTC (14 Jun)', venue: 'BC Place, Vancouver', group: 'D', matchday: 1, prediction: 'Australia 1-2 Türkiye' }}
        servers={[
        ...
        kickoffTimes={[{"flag":"🇨🇦","country":"Vancouver","time":"21:00"},{"flag":"🇫🇷","country":"Paris","time":"06:00+1"},{"flag":"🇬🇧","country":"London","time":"05:00+1"},{"flag":"🇺🇸","country":"New York","time":"00:00+1"},{"flag":"🇸🇦","country":"Riyadh","time":"07:00+1"},{"flag":"🌍","country":"UTC","time":"04:00+1"}]}
        faqs={[
          ...
          { q: 'What time is Australia vs Türkiye kick-off?', a: 'Saturday, 13 June 2026 at 04:00 UTC (14 Jun). Watch free on SportaLive.' },
