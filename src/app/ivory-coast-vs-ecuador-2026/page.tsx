  ...
  return (
    <>
      ...
      <WC2026MatchLayout
        ...
        meta={{ date: 'Sunday, 14 June 2026', time: '23:00 UTC', venue: "Lincoln Financial Field, Philadelphia", group: 'E', matchday: 1, prediction: 'Ivory Coast 1-1 Ecuador' }}
        servers={[
        ...
        kickoffTimes={[{"flag":"🇺🇸","country":"Philadelphia","time":"19:00"},{"flag":"🇫🇷","country":"Paris","time":"01:00+1"},{"flag":"🇬🇧","country":"London","time":"00:00+1"},{"flag":"🇺🇸","country":"New York","time":"19:00"},{"flag":"🇸🇦","country":"Riyadh","time":"02:00+1"},{"flag":"🌍","country":"UTC","time":"23:00"}]}
        faqs={[
          ...
          { q: 'What time is Ivory Coast vs Ecuador kick-off?', a: 'Sunday, 14 June 2026 at 23:00 UTC. Watch free on SportaLive.' },
